...
created: 2026-04-22
updated: 2026-04-22
related: [[index]], [[rebrand-smalti]], [[rebrand-partide]], [[watcher-performance]], [[main-process-cpu-home-watcher-bugfix]]
---
...
6. **Rust 크레이트 이름/네임스페이스**: 리브랜드([[rebrand-smalti]]) 확정 후 `smalti-core` 같은 이름으로 시작할지, `aide-core`로 먼저 시작 후 리네임할지.
...
- [[index]] — Wiki 전체 인덱스
- [[rebrand-smalti]] — 현 확정 후보 브랜드 아이데이션 (crate 네이밍 smalti-core 기준)
